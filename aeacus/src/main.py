...
if __name__ == '__main__':
    ...
    og_classifier_losses, og_classifier_accuracies, og_eval_losses, og_eval_accuracies = \
    ...
    aug_classifier_losses, aug_classifier_accuracies, aug_eval_losses, aug_eval_accuracies = \
        aug_classifier.train(encoder, aug_train_X, aug_train_y, test_X, test_y, aug_optimizer)

    ## TODO: find the PRAUC using scikitlearn


    end = time.time()
    seconds = end - start
    print('The process took {} seconds, of which {} went to training the autoencoder'.format(seconds, train_model_time))
